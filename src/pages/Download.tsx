  ...
  return (
    <>
      ...
      <Helmet>
        ...
        <meta
          name="description"
          content="Download the latest version of the Aham compiler and virtual machine for Linux, Windows, and macOS."
        />

        <link rel="canonical" href="https://ahamlang.tech/download" />
      </Helmet>
      <article className="page">
        <header className="page-header">
          <h1>Download</h1>
          <p className="lead">
            Get Aham 1.0.0 — the compiler and runtime for your platform.
          </p>
        </header>
