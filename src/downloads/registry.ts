    ...
    downloads: [
      {
        ...
        size: '197 KB',
        path: '/aham.dev/artifacts/debian/aham_1.0.0_amd64.deb',
      },
      {
        id: 'rpm',
        name: 'Fedora / RHEL',
        ...
        size: '203 KB',
        path: '/aham.dev/artifacts/rpm/Aham-1.0.0-Linux.rpm',
      },
      {
        id: 'linux-tarball',
        ...
        size: '196 KB',
        path: '/aham.dev/artifacts/linux/Aham-1.0.0-Linux.tar.gz',
      },
    ],
  },
  {
    ...
    downloads: [
      {
        ...
        size: '161 KB',
        path: '/aham.dev/artifacts/mac/Aham-1.0.0-Darwin.dmg',
      },
    ],
  },
  {
    ...
    downloads: [
      {
        ...
        size: '346 KB',
        path: '/aham.dev/artifacts/windows/Aham-1.0.0-win64.exe',
      },
    ],
  },
]
